...
class Pass1 {
    ...
    public static void main(String[] args) {
        ...
        OPTAB.put("STOP", new OpInfo("IS", 00));
        OPTAB.put("ADD", new OpInfo("IS", 01));
        OPTAB.put("SUB", new OpInfo("IS", 02));
        OPTAB.put("MULT", new OpInfo("IS", 03));
        OPTAB.put("MOVER", new OpInfo("IS", 04));
        OPTAB.put("MOVEM", new OpInfo("IS", 05));
        OPTAB.put("COMP", new OpInfo("IS", 06));
        OPTAB.put("BC", new OpInfo("IS", 07));
        OPTAB.put("DIV", new OpInfo("IS", 08));
        OPTAB.put("READ", new OpInfo("IS", 09));
        OPTAB.put("PRINT", new OpInfo("IS", 10));

        OPTAB.put("DC", new OpInfo("DL", 01));
        OPTAB.put("DS", new OpInfo("DL", 02));

        OPTAB.put("START", new OpInfo("AD", 01));
        OPTAB.put("END", new OpInfo("AD", 02));
        OPTAB.put("ORIGIN", new OpInfo("AD", 03));
        OPTAB.put("EQU", new OpInfo("AD", 04));
        OPTAB.put("LTORG", new OpInfo("AD", 05));
        ...
        POOLTAB.add(1); // first pool starts from literal #1
